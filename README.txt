=== Tasdid Gateway: UnOfficial Gateway Integration ===
...
This plugin allows you to add Tasdid as payment gateway for your WooCommerce store
...
3. Select `wp-tasdid-gateway.zip` and then click on upload.
4. Activate the plugin
5. Add your secret key from WooCommerce -> Settings -> Payments -> Tasdid Gateway
6. Thats it :)

Using File Manager:
1. Download the project as .zip file from Code -> Download Zip
2. Upload `wp-tasdid-gateway.zip` to the `/wp-content/plugins/` directory
3. Extract wp-tasdid-gateway.zip
...
== Disclaimer Of Tasdid Gateway: UnOfficial Gateway Integration ==
This plugin, Tasdid Gateway: UnOfficial Gateway Integration, is provided on an "as is" and "as available"
